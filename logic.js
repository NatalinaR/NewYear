...
$('.drop').click(function() {
   if ($(this).hasClass('future')) {
    ...
    $('#modal .wrapper .wrappercontent .box').html("<h2>Так, так, так. Кто-то пытается раньше времени открыть сюрприз!</h2> <p>Понимаю, нетерпится увидеть всё, но наберёмся терпения <br> и насладимся день за днём!</p>");
